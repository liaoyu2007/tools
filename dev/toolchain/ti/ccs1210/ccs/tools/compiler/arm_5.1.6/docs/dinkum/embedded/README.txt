...
The Dinkum C/EC++ Library Reference is Copyright (c) 1992-2003
by P.J. Plauger. This code is protected by copyright. ALL
RIGHTS RESERVED.

Version 4.02. This set of files constitutes the entire Dinkum
C/EC++ Library Reference. It is for use only by the licensed
user. See the file crit_pjp.html (reachable via the Copyright
hot link at the bottom of every page) for detailed restrictions.
...
``Dinkum Embedded C++ Reference.'' Drag the shortcut onto the
